...
[**INDEKS.md**](./INDEKS.md) to mapa całego repo. Wybierasz obszar (hałas, rowery, uspokojenie ruchu, transparentność, instytucje) i wchodzisz w `index.md` — dostajesz uporządkowany zestaw źródeł i szablonów.
...
- [**research/instytucje/**](./research/instytucje/index.md) — pełna mapa kompetencji (kto jest właściwy rzeczowo i miejscowo — kluczowe, bo niewłaściwy adresat = miesiące zwłoki).
...
4. Dodaj wpis do `research/<obszar>/index.md`.
