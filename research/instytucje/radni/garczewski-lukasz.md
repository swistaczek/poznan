---
title: "Garczewski Lukasz (Spoleczny Poznan)"
type: karta-radnego
tier: 2
frakcja: Społeczny Poznań
...
Aktywny partner — pełna zbieżność z agendą repo. Lider ruchu miejskiego; komitet Społeczny Poznań zbudowany dokładnie wokół priorytetów: zrównoważony transport, jakość przestrzeni publicznej, partycypacja. Angażować priorytetowo.
...
| **Funkcja** | Radny; lider ruchu miejskiego |
| **Kontakt** | e-mail BIP |
| **Forma zwrotu** | „Szanowny Panie Radny" |
| **Preferowany kanał** | `[do weryfikacji — prawdopodobnie social media + e-mail]` |

## Punkt wejścia

Profil w pełni zbieżny z agendą repo: zrównoważony transport, jakość przestrzeni publicznej, partycypacja społeczna. Nie wymaga framingu ani specjalnego języka — mówi tym samym językiem. Otwiera go każdy projekt poprawiający przestrzeń publiczną, ograniczający dominację samochodu lub wzmacniający partycypację.

## Obszary współpracy

- **Wszystkie tematy repo**: hałas, DDR, uspokojenie ruchu, transparentność — pełna zbieżność.
- **Ruch miejski**: naturalny sojusznik w budowaniu koalicji publicznej wokół spraw transportowych.
- **Partycypacja**: może wzmocnić inicjatywy obywatelskie przez sieć ruchu miejskiego.
...
- [ ] Konkretny projekt lub problem do zgłoszenia
- [ ] Dane / dokumentacja
