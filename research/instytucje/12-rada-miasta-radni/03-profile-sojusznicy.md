...
**Poglądy**: Konsekwentne wsparcie dla uspokajania ruchu, stref Tempo 30, priorytetyzacji tramwaju kosztem transportu indywidualnego. Poglądy niezmienne od lat.

**Persona**: Pragmatyczny technokrata. Unika emocji, preferuje twarde dane — wskaźniki bezpieczeństwa, modele przepustowości. Angażuje się w debaty publiczne na social mediach wyważenie i analitycznie.

**Kontakt**: Formalna korespondencja + niezależna ekspertyza techniczna. Tel. BIP 61 878 53 12.

**Punkt wrażliwości**: Statystyki wypadkowości + analizy porównawcze z miast europejskich (efektywność proponowanych rozwiązań).
...
**Persona**: Empatyczna, język zaangażowania społecznego i sprawiedliwości miejskiej. Bardzo aktywna w social mediach, nie unika konfrontacji z krytykami. Doskonałe wyczucie nastrojów lokalnych.

**Kontakt**: Social media + odwoływanie się do głosu rad osiedli. E-mail BIP.

**Punkt wrażliwości**: Społeczna krzywda + oddolna presja mieszkańców. Idealna adresatka interpelacji w sprawie hałasu tramwajowego na Jeżycach — dostarczyć materiał z amatorskimi pomiarami akustycznymi i relacjami mieszkańców.
...
**Persona**: Analityczny, autorytatywny. Doskonale rozumie procesy wewnątrz urzędu — odporny na biurokratyczne uniki spółek miejskich. Tel. BIP 61 878 53 12.

**Punkt wrażliwości**: Argumentacja makroekonomiczna i socjalna. Wykazać, jak projekt poprawi bezpieczeństwo seniorów/dzieci i obniży koszty zewnętrzne systemu transportowego. Bezpośrednio może wywierać presję polityczną na kadrę kierowniczą MPK (omijając standardową ścieżkę biurokratyczną).
...
**Kontakt**: Osobiste spotkania i spacery badawcze w jej okręgu. E-mail BIP.

**Punkt wrażliwości**: Bezpieczeństwo pieszych — zwłaszcza seniorów. Stanie na czele protestu przeciwko wycięciu drzew pod przepustowość ulicy. Angażować przy konfliktach: DDR vs. starodrzew — wymusi przeprojektowanie.
...
**Poglądy**: Nie wchodzi w ideologiczne spory o wyższość środków transportu — skupia się na rozwiązywaniu punktowych problemów. Odgórna dyscyplina partyjna łączy się z silną autonomią w sprawach osiedlowych.

**Persona**: Skrajnie sformalizowany. Odpowiada niemal na wszystkie zgłoszenia publiczne.

**Kontakt**: Dobrze udokumentowany wniosek (amatorskie pomiary akustyczne, fotografie, liczby) → natychmiastowe przekształcenie w oficjalną interpelację → urząd musi odpowiedzieć formalnie → podstawa do dalszych działań prawnych. E-mail BIP.

**Punkt wrażliwości**: Konkretna, udokumentowana uciążliwość punktowa — nie „hałas tramwajowy w Poznaniu" ale „ul. Dąbrowskiego 96, pomiary 78 dB, daty, godziny".
