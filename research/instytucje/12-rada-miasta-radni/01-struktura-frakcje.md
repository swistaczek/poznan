# Struktura Rady Miasta Poznania (kadencja 2024–2029)

## Skład i prezydium

- Kadencja: 2024–2029 (IX kadencja).
- Liczba radnych: **34** w 6 okręgach (okręgi 1–2: po 5 radnych; okręgi 3–6: po 6 radnych) `[do weryfikacji — w dyskursie analitycznym operuje się historyczną liczbą 37]`.
- **Przewodniczący RM**: Grzegorz Ganowicz (KO) — tel. BIP 61 878 53 08.
- **Wiceprzewodniczący**:
  - Łukasz Kapustka `[frakcja do wer.]`
  - Andrzej Rataj (KO)
  - Mateusz Rozmiarek (PiS) — Okręg 2
...
| Komisja | Przewodniczący | Znaczenie dla repo |
|---|---|---|
...
| Komisja Rewizyjna | [do wer.] — historycznie: Bonk-Hammermeister | Kontrola finansowa spółek komunalnych (MPK, ZDM, PIM) |

## Mechanika władzy

- Komisje stałe = **właściwe laboratoria decyzji** (nie sesje plenarne).
- Komisja Transportu: rekomendacja dla ZDM jest de facto wiążąca — obywatel lobbujący tam ma najwyższe szanse na sukces.
- Komisja Polityki Przestrzennej: ścisła symbioza z Miejską Pracownią Urbanistyczną (MPU) — wymagane najwyższe przygotowanie legislacyjne od lobbysty.
- Dyscyplina partyjna: żelazna w głosowaniach makroekonomicznych (budżet, absolutorium); poluzowana w sprawach mikro-przestrzennych.
