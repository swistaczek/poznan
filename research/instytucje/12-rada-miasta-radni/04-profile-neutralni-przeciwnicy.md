...
**Poglądy**: Ewolucyjne, nie rewolucyjne zmiany w przestrzeni. Sceptyczny wobec nagłych zmian transformacyjnych, które alienują umiarkowany elektorat.

**Persona**: Powściągliwy, wyważony, dyplomatyczny. W social mediach: głównie kontekst reprezentacyjny i kulturalny. Tel. BIP 61 878 53 08.

**Strategia kontaktu**: Bezpośredni nacisk na Ganowicza w sprawach mikro (punktowy hałas tramwajowy) = marnowanie zasobów — deleguje do komisji. Angażować tylko przy eskalacjach instytucjonalnych: gdy organ podległy Prezydentowi łamie prawa obywateli lub ignoruje radnych.

**Punkt wrażliwości**: Dbałość o powagę i autorytet Rady. Reaguje na skargi dotyczące ignorowania przez jednostki miejskie — nie na skargi na politykę transportową.
...
**Persona**: Wysoce sformalizowany, chłodny, zdystansowany. Argumenty emocjonalne = nieskuteczne. Reaguje wyłącznie na rygorystyczne analizy przestrzenne, wskaźniki intensywności zabudowy, przepisy prawa budowlanego. E-mail BIP.

**Punkt wrażliwości**: Spójność prawna dokumentów planistycznych. Wykazanie błędu proceduralnego lub niezgodności ze studium = może całkowicie odwrócić jego decyzję. Uwagi do MPZP formułować jako zarzuty procesowe, nie jako postulaty społeczne.
...
**Persona**: Merytoryczny, wyczerpujące wyjaśnienia w social mediach (długie formy). Nie ulega demonstracjom. Wiedza techniczna na nim nie robi wrażenia — ma pełne zaplecze ekspertów. E-mail BIP.

**Punkt wrażliwości**: Szerokie, ponadbańkowe poparcie społeczne. Udowodnić, że rozwiązanie nie wygeneruje buntu elit biznesowych w dzielnicy. Liczby dotyczące akceptacji społecznej (sondaże, podpisy) są tu ważniejsze niż ekspertyzy techniczne.
...
**Poglądy**: Ocenia przez pryzmat ROI i kosztów operacyjnych. Nie romantyzm miejski — jeśli nowa zieleń generuje wysokie koszty utrzymania bez gwarancji środków, zagłosuje przeciw. E-mail BIP.

**Punkt wrażliwości**: Oszczędności finansowe. Strategie nacisku:
- Zwężenie ulicy → mniejsze koszty odtworzenia nawierzchni po zimie.
- DDR → obniżenie nakładów na służbę zdrowia (metodologia HEAT dla ruchu rowerowego).
- Hałas tramwajowy → koszty zdrowotne i wibracyjna degradacja kamienicznej tkanki (koszty remontów).
...
**Strategia**: Dostarczyć mu precyzyjne dane o opóźnieniach w inwestycjach lub błędach w specyfikacjach przetargowych → natychmiastowe nagłośnienie medialne → władze zmuszone do reakcji. Idealny do upolitycznienia tematu UDIP (patrz FAQ pyt. 6).
